    ...
    <>
      ...
      <div className="min-h-screen bg-[#09090B] max-w-lg mx-auto px-4 pb-16 anim-page">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-white tracking-tight">Privacy & Security</h1>
              ...
              <form onSubmit={handleChangePassword} className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full bg-zinc-800/80 border border-zinc-700 rounded-xl py-2.5 px-4 pr-11 text-sm text-white placeholder-zinc-600 focus:border-red-600 transition-colors"
                    />
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={'w-full bg-zinc-800/80 border rounded-xl py-2.5 px-4 text-sm text-white placeholder-zinc-600 focus:border-red-600 transition-colors ' +
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-red-600 text-white font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-40 pressable mt-1"
                >
          ...
          <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-4">
            ...
            {resetSent ? (
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-zinc-800 border border-zinc-700 text-zinc-300 font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-40 pressable hover:border-zinc-600 transition-colors"
              >
          ...
          <div className="mb-6 anim-fade-up" style={{ animationDelay: '0.15s' }}>
            <div className="bg-blue-900/15 border border-blue-700/25 rounded-2xl p-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-blue-900/30 border border-blue-700/30 flex items-center justify-center flex-shrink-0">
